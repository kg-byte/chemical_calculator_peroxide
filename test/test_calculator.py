...
class TestCalculator():
	...
	def test_analyze_list(self):
		...
		assert result[1] == 'Product 2 contains 1.8% hydrogen peroxide and 1.4% content(Oa); it is an Organic Peroxide'
		assert result[2] == 'Product 3 contains 11.4% hydrogen peroxide and 0% content(Oa); it is an Organic Peroxide'
		assert result[3] == 'Product 4 contains 1.0% hydrogen peroxide and 0.5% content(Oa); it is not an Organic Peroxide'
